...
def vp_start_gui():
    ...
    root = tk.Tk()
    top = Toplevel1 (root)
    start_page_support.init(root, top)
    root.mainloop()
...
def create_Toplevel1(root, *args, **kwargs):
    ...
    w = tk.Toplevel (root)
    top = Toplevel1 (w)
    start_page_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Button1.configure(command=start_page_support.startOpenPage)
